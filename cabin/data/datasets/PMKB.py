...
class PMKBTable(RecordByRecordImportedTable):
    ...
    def schema(self):
        return """
            CREATE TABLE `{table}` (
                ...
                Tumor_types   TEXT            NOT NULL, -- '|' seperated, eg: Acute Myeloid Leukemia|T Lymphoblastic Leukemia/Lymphoma
                Tissue_types  TEXT            NOT NULL, -- '|' seperated, eg: Blood|Bone Marrow
    ...
    def read(self):
        for row in read_csv(self.inputs['PMKBFile'].path, encoding='utf-8'):
